...
sub _default_settings {
    ...
    return {
        ...
        loc_authority_timeout_seconds     => 8,
        loc_authority_result_limit        => 8,
        loc_authority_candidate_limit     => 5,
        loc_authority_cache_ttl_seconds   => 86400,
        loc_authority_cache_max_entries   => 1000,
        ai_retry_count                    => 1,
